...
public class Splash extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<>(Splash.this, R.layout.simple_list_item_1, arrayListpaired);

        have.setText("I HAVE �TEE");
        dontHave.setText("I DON'T HAVE �TEE");
        have.setTypeface(DataPref.dinMedium(getApplicationContext()));
        dontHave.setTypeface(DataPref.dinMedium(getApplicationContext()));
        head.setText("Switch Embassy's �Tee is a programmable digital t-shirt that allows anybody to wear who they truly are and Stay True.");
        ...
        contTxt.setText("I DON'T HAVE �TEE");
        upparHave.setText("I HAVE �TEE");
...
//Log.v("diff = ", dif+"");
        ...
        have.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mBluetoothAdapter == null) {
                    //have_bt = true;
                    Log.i(TAG, "you don't have bluetooth device");
                    Toast.makeText(view.getContext(), "No bluetooth adapter available", Toast.LENGTH_LONG)
                            .show();
                } else {
        ...
        upparHave.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mBluetoothAdapter == null) {
                    //have_bt = true;
                    Log.i(TAG, "you don't have bluetooth device");
                    Toast.makeText(view.getContext(), "No bluetooth adapter available", Toast.LENGTH_LONG).show();
                } else {
                    if (DataPref.mmSocket != null) {
                        startActivity(new Intent(Splash.this, ImageActivity.class));
                        finish();
                        ...
                        upparHave.setVisibility(View.INVISIBLE);
                        divider1.setVisibility(View.INVISIBLE);
                        dontRel.setVisibility(View.INVISIBLE);
        ...
        dontHave.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dontRel.setVisibility(View.VISIBLE);
                divider2.setVisibility(View.INVISIBLE);
                divider3.setVisibility(View.INVISIBLE);
                dontHave.setVisibility(View.INVISIBLE);
                ...
                anim.setAnimationListener(new AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        // TODO Auto-generated method stub
                        //dont_rel.setVisibility(View.VISIBLE);
                        divider1.clearAnimation();
                        have.clearAnimation();
                        divider4.setVisibility(View.VISIBLE);
                        upparHave.setVisibility(View.VISIBLE);
                        have.setVisibility(View.INVISIBLE);
                        divider1.setVisibility(View.INVISIBLE);
                    }
                });
    ...
    protected void onStart() {
        // TODO Auto-generated method stub
        super.onStart();
        FlurryAgent.init(getApplicationContext(), "69JVCKH5XT2XXQPJH5M5");
    ...
    private void getPairedDevices() {
        ...
        Log.v(TAG, "length of paired devices " + pairedDevice.size());
                    ...
                    for (int i = 0; i < bytesAvailable; i++) {
                        ...
                        if (dataByte == delimiter) {
                            ...
                            System.arraycopy(readBuffer, 0, encodedBytes, 0,
                                    encodedBytes.length);
                            final String data = new String(encodedBytes, Charset.forName("US-ASCII"));

                            readBufferPosition = 0;

                            Log.i(TAG, "data value: " + data);

                            if (data.startsWith(actualValue)) {
                                afterSuccess = true;
    ...
    public boolean processData() {
        data = new byte[]{(byte) 0xAA, (byte) 0xAA, 0x04, 0x00, 0x00, 0x00, 0x07, 0x00, (byte) 0xBB};
        if (!beforeSend(data, "images loaded from radio\r")) {
            return false;
        }

        data = new byte[]{(byte) 0xAA, (byte) 0xAA, 0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x12, (byte) 0xBB};
        if (!beforeSend(data, "matrix brightness:18")) {
            return false;
        }

        data = new byte[]{(byte) 0xAA, (byte) 0xAA, 0x04, 0x00, 0x00, 0x00, 0x04, 0x00, (byte) 0xBB};

        return beforeSend(data, "display:1");
    }
